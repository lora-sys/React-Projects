...
class SDK {
     ...
     *
     */
    transactionsSync(body, metadata) {
        return this.core.fetch('/wallet/transactions', 'patch', body, metadata);
    }
    /**
     * <b> 40 credits per request </b>
     *             <hr>
     ...
     *
     */
    walletCharts(metadata) {
        return this.core.fetch('/wallet/charts', 'get', metadata);
    }
    /**
     * <b> 1 credits per request </b>
     *             <hr>
     ...
     *
     */
    btcDominance(metadata) {
        return this.core.fetch('/insights/btc-dominance', 'get', metadata);
    }
    /**
     * <b> 50 credits per request </b>
     *             <hr>
     ...
     */
    fearAndGreed() {
        return this.core.fetch('/insights/fear-and-greed', 'get');
    }
    /**
     * <b> 50 credits per request </b>
     *             <hr>
     ...
     */
    fearAndGreedChart() {
        return this.core.fetch('/insights/fear-and-greed/chart', 'get');
    }
    /**
     * <b> 50 credits per request </b>
     *             <hr>
     ...
     *
     */
    rainbowChart(metadata) {
        return this.core.fetch('/insights/rainbow-chart/{coinId}', 'get', metadata);
    }
}
